            ...
            {(() => {
              ...
              return (
                <div style={{ display: "flex", gap: 12 }}>
                  ...
                  {smartWallet !== undefined && smartWallet.length > 0 ? (
                    <div className="relative flex flex-col justify-start items-center">
                      <button
                        ...
                        type="button"
                        className="border border-solid border-violet-500 py-1 px-4 font-normal text-xl rounded-full text-violet-500 active:border-white"
                      >
