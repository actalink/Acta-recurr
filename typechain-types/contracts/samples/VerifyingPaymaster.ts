...
export interface VerifyingPaymasterInterface extends utils.Interface {
  functions: {
    ...
    "getHashOffChain((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes),uint48,uint48,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getHashOffChain",
    values: [
      UserOperationStruct,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
...
export interface VerifyingPaymaster extends BaseContract {
  ...
  functions: {
    ...
    getHashOffChain(
      ...
      validUntil: PromiseOrValue<BigNumberish>,
      validAfter: PromiseOrValue<BigNumberish>,
      nextNonce: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[string]>;
