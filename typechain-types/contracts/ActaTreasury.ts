...
export interface ActaTreasuryInterface extends utils.Interface {
  functions: {
...
export interface ActaTreasury extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ActaTreasuryInterface;
  ...
  functions: {
    ...
    stakeInfo(
      ...
      overrides?: CallOverrides
    ): Promise<[BigNumber, boolean] & { amount: BigNumber; staked: boolean }>;
