...
export interface RootAccountFactoryInterface extends utils.Interface {
  functions: {
...
export interface RootAccountFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RootAccountFactoryInterface;
